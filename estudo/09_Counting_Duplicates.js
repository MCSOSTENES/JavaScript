...
function duplicateCount(text){
    text = text.split('').map((letter) => letter.toLowerCase()).sort().join('')
    let regex = /([a-z])(.*\1)/gi
...
console.log(duplicateCount("aabBcdebe")) //-> 2 # 'a' occurs twice and 'b' twice (`b` and `B`)
console.log(duplicateCount("indivisibility")) //-> 1 # 'i' occurs six time
